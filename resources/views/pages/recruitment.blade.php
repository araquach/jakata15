...
<p class="recruit_button"> {{ HTML::link('stylist/create', "Click Here to apply for a stylist position") }} </p>
...
<p class="recruit_button"> {{ HTML::link('apprentice/create', "Click Here to apply for an apprentice position") }} </p>
